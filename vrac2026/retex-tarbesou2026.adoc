...
WARNING: Troisième signe qui aurait dû nous alerter : il fait très chaud (on est vers midi) sur une zone qui subit des vents de toutes les orientations, donc très propices aux rafales turbulentes à mon avis.
